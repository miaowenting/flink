...
### 5.9.6 Flink 1.9实战：使用SQL读取Kafka并写入MySQL


学习 Flink 1.9.0 SQL 的工程: [https://github.com/wuchong/flink-sql-submit]
...
CREATE TABLE user_log (
    ...
    'connector.properties.1.value' = 'mwt:9092',
    'update-mode' = 'append',
    'format.type' = 'json',
